...
> This layer contains the labels for all used addresses within the city of Dayton city limits.

## Source

- **Publisher:** City of Dayton (ArcGIS Online, owner `emma.jewell`)
- **Service type:** Map Service
- **Service URL:** https://maps.daytonohio.gov/gisservices/rest/services/Basemaps/Dayton_Used_Address/MapServer
- **Item page:** https://daytonohio.maps.arcgis.com/home/item.html?id=b8686f462c354e82909d46257cc56297
- **Created:** 2018-11-09  ·  **Item modified:** 2018-11-09
- **Tags:** City of Dayton, Used Address
- **License/terms:** Map and parcel data are believed to be accurate, but accuracy is guaranteed. This is not a legal document and should not be substituted for a title search, appraisal, survey, or for zoning verification.

## Publisher description

This layer contains the labels for all used addresses within the city of Dayton city limits.

## Layer 0: Address Number Label
