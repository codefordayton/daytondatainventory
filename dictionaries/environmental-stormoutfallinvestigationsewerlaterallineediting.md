# Environmental/StormOutfallInvestigationSewerLateralLineEditing
...
- **Service URL:** https://maps.daytonohio.gov/gisservices/rest/services/Environmental/StormOutfallInvestigationSewerLateralLineEditing/FeatureServer
- **Item page:** https://daytonohio.maps.arcgis.com/home/item.html?id=Environmental_StormOutfallInvestigationSewerLateralLineEditing
...
## Layer 1: EnvMgmtOutfallInvestigation_ssLateralLine__ATTACH
...
## Layer 2: EnvMgmtOutfallInvestigation_ssLateralLine
...
| `DryWeather` | String |  | **Values:** `Y` = Yes; `N` = No; `U` = Unknown; `NA` = NA; `Other` = Other; `Unsure` = Unsure; `Yes` = Yes; `No` = No · len 10 |
| `Flow` | String | FlowPrsent | **Values:** `Y` = Yes; `N` = No; `U` = Unknown; `NA` = NA; `Other` = Other; `Unsure` = Unsure; `Yes` = Yes; `No` = No · len 10 |
