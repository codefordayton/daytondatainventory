...
- **Service URL:** https://maps.daytonohio.gov/gisservices/rest/services/MapLayers_Testing/MapServer
- **Item page:** https://daytonohio.maps.arcgis.com/home/item.html?id=MapLayers_Testing
- **Created:** None  ·  **Item modified:** None

## Layer 0: Used Address
...
| `Shape` | Geometry |  |  |
| `OBJECTID_1` | OID |  |  |
| `GlobalID_1` | Double | Shape.STArea() |  |
| `Shape.STArea()` | Double |  |  |
| `Shape.STLength()` | Double |  |  |

</details>

## Layer 5: Administrative Boundaries
...
| Field | Type | Alias | Notes |
|---|---|---|---|
| `NAME` | String | School Name | len 255 |
| `DISTRCTNAME` | String | School District Name | len 255 |
...
## Layer 10: Dayton Corporation Boundary
...
## Layer 13: addressParcelCamaSL_VW
