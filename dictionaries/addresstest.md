...
- **Service URL:** https://maps.daytonohio.gov/gisservices/rest/services/AddressTest/FeatureServer
- **Item page:** https://daytonohio.maps.arcgis.com/home/item.html?id=AddressTest
...
| `LUC_Int` | String |  | len 255 |
| `LUC_Description` | String |  | len 255 |
| `ZONING_CODE` | String |  | len 255 |
| `PRI_BOARDSORT` | String |  | len 255 |
| `PRI_BOARD` | String |  | len 255 |
| `HIST_DIST_CODE` | String |  | len 255 |
| `PRIMARYADDR` | String | Primary Address | **Values:** `Y` = Y; `N` = N · len 5 |
