# FieldMaps/MapLayers_AllUtilities

## Source

- **Publisher:** City of Dayton (ArcGIS Online, owner `City of Dayton GIS (on-premise)`)
- **Service type:** Map Service
- **Service URL:** https://maps.daytonohio.gov/gisservices/rest/services/FieldMaps/MapLayers_AllUtilities/MapServer
- **Item page:** https://daytonohio.maps.arcgis.com/home/item.html?id=FieldMaps_MapLayers_AllUtilities
...
| Field | Type | Alias | Notes |
|---|---|---|---|
| `TAXPINNO` | String | Parcel ID | len 20 |
| `TAXAREA` | String | Tax Area | len 10 |
| `TAXDISTRIC` | String | Tax District | len 5 |
| `TAXBOOK` | String | Tax Book | len 4 |
| `TAXPAGE` | String | Tax Page | len 2 |
| `TAXSUF` | String | Tax Suffix | len 1 |
| `TAXINDEX` | String | Tax Index | len 4 |
| `LOTNUMBER` | String | Lot Number | len 20 |
| `ACREAGE` | String | Acreage | len 12 |
| `LOC_NBR` | Double | Street Number |  |
| `LOC_DIR` | String | Street Direction | len 4 |
| `LOC_STREET` | String | Street Name | len 50 |
| `LOC_SUFFIX` | String | Street Suffix | len 10 |
| `LOC_AREA` | String | Jurisdiction | len 30 |
| `K_PID` | String | Key Parcel ID | len 18 |
| `NBHD_1` | String | Neighborhood Code | len 10 |
| `HOT_LINK` | String | Link | len 75 |
| `PHOTO_LINK` | String | Parcel ID - Photo Link | len 100 |
| `WEB_BKPG_LINK` | String | Tax Map Link | len 100 |
| `C_BLOCK` | String | Census Block | len 20 |
| `C_TRACK` | String | Census Tract | len 20 |
...
| `METSERVICE` | String | Metered Service | len 5 |
| `SERVICETYPE` | String | Service Type | **Values:** `Domestic` = Domestic; `Commercial` = Commercial; `Industrial` = Industrial; `Fire` = Fire; `Other` = Other; `Unknown` = Unknown · len 50 |
| `INSTALLDATE` | Date | Install Date |  |
| `LOCDESC` | String | Location Description | len 200 |
| `ROTATION` | Double | Rotation |  |
...
| `PRESZONE` | String | Pressure Zone | **Values:** `High` = High; `Low` = Low; `SH` = Super High · len 4 |
| `REMMFGKEY` | Integer | Remote Manufacturer |  |
...
## Layer 16: Enclosed Storage Facilities
...
## Layer 20: Water Hydrant Laterals
...
## Layer 31: Storm Network Structures
...
## Layer 38: Storm Network Structures
...
## Layer 43: Sanitary Network Structures
...
## Layer 48: Sanitary System Valves
...
## Layer 49: Sanitary Control Valves
...
## Layer 50: Sanitary Gravity Mains - Lining
...
## Layer 57: Sanitary Network Structures
...
## Layer 59: Sanitary Gravity Mains
...
## Layer 67: Well Head Operation Areas
...
## Layer 68: Water Protection District
...
## Layer 70: Administrative Boundaries
...
## Layer 72: Dayton Corporation Boundary
...
| `ABR` | String | Neighborhood Abbreviation | len 35 |
| `PLC_BEAT` | Integer | Police Beat |  |
| `PLC_DISTR` | Integer | Police District |  |
| `ACRES` | Double | Acres |  |
...
## Layer 74: County-City_Twp Boundaries
...
## Layer 76: addressParcelCamaSL_VW
